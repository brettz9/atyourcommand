								...
								createProcessAtPath(
									...
									data.args.map(function (argVal) {
										...
										return argVal.replace(
											/<(save-temp-)?(uc?encode-)?(?:(pageURL)|(pageTitle)|(pageHTML)|(bodyText)|(selectedHTML)|(selectedText)|(linkPageURL)|(linkPageURLAsNativePath)|(linkPageTitle)|(linkBodyText)|(linkPageHTML)|(imageURL)|(imageDataURL)|(imageDataBinary))>/g,
											function () {
