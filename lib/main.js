                        ...
                        switch (id) {
                            ...
                            case 'execute':
                                createProcessAtPath(
                                    ...
                                    // Todo: handle hard-coded data.files and data.urls; ability to invoke with
                                    ...
                                    data.args.map(function (argVal) {
                                        ...
                                        return argVal.replace(
                                            /<(save-temp-)?(uc?encode-)?(?:(eval [^>]*)|(pageURL)|(pageTitle)|(pageHTML)|(bodyText)|(selectedHTML)|(selectedText)|(linkPageURL)|(linkPageURLAsNativePath)|(linkPageTitle)|(linkBodyText)|(linkPageHTML)|(imageURL)|(imageDataURL)|(imageDataBinary))>/g,
                                            function () {
