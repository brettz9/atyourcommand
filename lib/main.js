    ...
    onMessage: function (e) {
        ...
        case 'one-off':
            ...
            win.addEventListener('load', function () {
                ...
                tabs.activeTab.url = data.url('one-off.html'); // Todo: Pass locale within HTML file name or use "data-l10n-id" attribute in HTML (ugly but more maintenable with HTML changes)
            });
            break;
        case 'prefs':
